...
<?php include('includes/leftbar.php');?>                   
  ...
  <div class="form-group has-success">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"><span class="copyright-text">&#169; <?php echo date("Y"); ?> All rights reserved. Made with &#x1F49C; by <b><a href="https://www.youtube.com/channel/UC4_6-VSWBw_QHMyjrDDEvVQ"> GPW</a></b> Team.</span></p></div>
        </footer>
    </body>
</html>
<?php  } ?>
