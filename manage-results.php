                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT  distinct tblstudents.StudentName,tblstudents.RollId,tblstudents.StudentId,tblclasses.ClassName, tblclasses.ClassNameNumeric,tblclasses.Section from tblresultsss join tblstudents on tblstudents.StudentId=tblresultsss.StudentId  join tblclasses on tblclasses.id=tblresultsss.ClassId";
