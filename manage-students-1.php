...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>succesfull</strong><?php echo htmlentities($msg); ?>
 </div><?php } 
else if($error){?>
...
<?php $sql = "SELECT tblstudentss.StudentName,tblstudentss.RollId,tblstudentss.StudentId,tblclassess.ClassName,tblclassess.ClassNameNumeric,tblclassess.Section from tblstudentss join tblclassess on tblclassess.id=tblstudentss.ClassId";
$query = $dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
