...
if(strlen($_SESSION['alogin'])=="" || $_SESSION['role'] !== 'Teacher1')
...
if(isset($_SESSION['alogin']) && $_SESSION['role'] === 'Teacher1') {
    // Establish database connection
    try {
        $sql1 = "SELECT StudentId FROM tblstudentss";
...
if(isset($_SESSION['alogin']) && $_SESSION['role'] === 'admin') {
    // Establish database connection
    try {
        $sql = "SELECT id FROM tblsubjectss";
...
?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%;">
                                        ...
                                        <?php 
$sql2 ="SELECT DISTINCT(ClassName) from  tblclassess ";
...
?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"  style="margin-top:1%">
                                        ...
                                        <?php 
$sql3="SELECT  distinct StudentId from  tblresults ";
